...
public class HospitalOverviewDto {
    private Long id;
    private Long strutturaId;          // <-- Aggiunto per il matching con la select Angular (optionValueKey: 'strutturaId')
    ...
    // --- ALIAS GETTER PER COMPATIBILITÀ CON FRONTEND ---
    public Long getStrutturaId() {
        return this.strutturaId != null ? this.strutturaId : this.id;
    }
}